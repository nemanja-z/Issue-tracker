  ...
  Mutation: {
    createIssue: async (_, {
      ...
      try {
        ...
        const issue = await models.Issue.create({ ...input,
          attachment,
          reporterId: user.id,
    ...
    editIssue: async (_, args, {
      ...
      try {
        ...
        await models.Issue.update(data, {
          where: {
            id: args.issueId
          }
        });
